namespace :manage_deploy_data do
  ...
  namespace :abandoned_properties do
    ...
    task voice_files: :environment do
      ...
      ["property_comments", "property_outcome", "thanks", "welcome", "code_prompt", "error1", "error2", "consent", "listen_to_messages_prompt", "no_feedback_yet", "listen_to_another"].each do |short_name|
